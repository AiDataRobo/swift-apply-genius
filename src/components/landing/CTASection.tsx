  ...
  return (
    <section className="py-24 relative">
      ...
      <div className="container max-w-5xl mx-auto px-6 relative z-10">
        <div className="glass-card bg-foreground text-background p-12 md:p-16 rounded-3xl relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <Button className="glass-button bg-background text-foreground hover:bg-background/90 py-6 px-8 text-lg rounded-xl">
              Try for Free Now
