    ...
    <footer className="bg-foreground text-background pt-16 pb-8">
      <div className="container max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <p className="text-background/70 mb-6">
              AI-powered Resume & Cover Letter Generator helping job seekers land their dream roles.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-background/70 hover:text-primary transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.016 18.124c-.608.274-1.289.46-1.978.511-1.717.124-3.475-.186-4.979-1.42-1.505-1.236-2.367-3.157-2.367-5.062 0-3.86 3.146-7 7.032-7a7.023 7.023 0 017.019 7.359 6.993 6.993 0 01-3.269 5.595 6.993 6.993 0 01-1.458.017zM18.75 6.5h-1.5a.25.25 0 00-.25.25v1.5c0 .138.112.25.25.25h1.5a.25.25 0 00.25-.25v-1.5a.25.25 0 00-.25-.25zm-8.5 3h-1.5a.25.25 0 00-.25.25v6.5c0 .138.112.25.25.25h1.5a.25.25 0 00.25-.25v-6.5a.25.25 0 00-.25-.25zm4.25 0h-1.5a.25.25 0 00-.25.25v6.5c0 .138.112.25.25.25h1.5a.25.25 0 00.25-.25v-6.5a.25.25 0 00-.25-.25zm4.25 0h-1.5a.25.25 0 00-.25.25v6.5c0 .138.112.25.25.25h1.5a.25.25 0 00.25-.25v-6.5a.25.25 0 00-.25-.25z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-background/70 hover:text-primary transition-colors">Career Tips</a></li>
              <li><a href="#" className="text-background/70 hover:text-primary transition-colors">Interview Guide</a></li>
              <li><a href="#" className="text-background/70 hover:text-primary transition-colors">Resume Templates</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-background/10 text-center text-background/50 text-sm">
          <p>&copy; {currentYear} SwiftApply. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
