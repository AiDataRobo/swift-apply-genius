      ...
      <div className="container max-w-7xl text-center relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-8 flex-wrap">
            ...
            <motion.div 
              ...
              whileHover={{ y: -3 }}
            >
              <svg className="h-full w-auto" viewBox="0 0 137 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M56.2427 7.88281H60.4252V22.4766H56.2427V7.88281Z" fill="currentColor"/>
                <path d="M61.5193 16.041C61.5193 12.1441 64.3018 8.91211 68.3424 8.91211C72.3831 8.91211 75.1655 12.1441 75.1655 16.041C75.1655 19.9379 72.3831 23.1699 68.3424 23.1699C64.3018 23.1699 61.5193 19.9967 61.5193 16.041ZM71.0834 16.041C71.0834 14.1855 69.9893 12.8027 68.3424 12.8027C66.6955 12.8027 65.6014 14.1855 65.6014 16.041C65.6014 17.8965 66.6955 19.2793 68.3424 19.2793C69.9893 19.2205 71.0834 17.8965 71.0834 16.041Z" fill="currentColor"/>
                <path d="M85.4543 9.19727H89.1717L85.0897 21.5078C83.9956 24.9785 81.9493 26.2441 78.9033 26.2441C78.245 26.2441 77.5279 26.1855 77.0214 26.0684V22.5352C77.4102 22.6523 77.9167 22.7109 78.3643 22.7109C79.6412 22.7109 80.4754 22.0176 80.8642 20.6934L80.9818 20.2695L76.6327 9.25586H80.5342L83.0441 17.1973H83.1029L85.4543 9.19727Z" fill="currentColor"/>
                <path d="M107.099 7.88281V16.3477C107.099 20.5977 104.552 23.1699 100.629 23.1699C96.7064 23.1699 94.1377 20.5977 94.1377 16.3477V7.88281H98.3202V16.1719C98.3202 18.0273 99.1544 19.2344 100.688 19.2344C102.221 19.2344 103.056 18.0273 103.056 16.1719V7.88281H107.099Z" fill="currentColor"/>
                <path d="M115.845 18.7793V22.4766H114.04C111.112 22.4766 109.525 20.8555 109.525 17.9707V12.8027H107.779V9.19727H109.525V5.5H113.707V9.19727H115.845V12.8027H113.707V17.7949C113.707 18.4883 114.04 18.7793 114.751 18.7793H115.845Z" fill="currentColor"/>
                <path d="M116.937 16.041C116.937 12.1441 119.72 8.91211 123.76 8.91211C127.801 8.91211 130.583 12.1441 130.583 16.041C130.583 19.9379 127.801 23.1699 123.76 23.1699C119.72 23.1699 116.937 19.9967 116.937 16.041ZM126.501 16.041C126.501 14.1855 125.407 12.8027 123.76 12.8027C122.113 12.8027 121.019 14.1855 121.019 16.041C121.019 17.8965 122.113 19.2793 123.76 19.2793C125.407 19.2205 126.501 17.8965 126.501 16.041Z" fill="currentColor"/>
                <path d="M132.128 9.19727H136.193V11.8867H136.251C136.876 10.0312 138.345 9.10547 140.05 9.10547C140.459 9.10547 140.859 9.16406 141.201 9.28125V13.0352C140.751 12.8594 140.127 12.7422 139.503 12.7422C137.524 12.7422 136.311 14.1855 136.311 16.3477V22.4766H132.128V9.19727Z" fill="currentColor"/>
              </svg>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-xl shadow-2xl border border-gray-100">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1571867424488-c00140042dea?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1600&q=80"
                alt="AI Resume Application Interface" 
            ...
            <motion.div 
              className="absolute top-20 right-10 bg-white p-3 rounded-lg shadow-lg text-left"
            ...
            >
              <div className="text-xs font-semibold text-green-600 flex items-center">
                <Check className="h-3 w-3 mr-1" /> ATS-Optimized
              </div>
              <div className="text-xs text-gray-500">Your resume ranks in the top 10%</div>
            </motion.div>
            
            <motion.div 
              className="absolute bottom-20 left-10 bg-white p-3 rounded-lg shadow-lg text-left max-w-[200px]"
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 1.8 }}
              whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
            >
              <div className="text-xs font-semibold flex items-center text-primary">
                <Sparkles className="h-3 w-3 mr-1" /> AI Suggestion
              </div>
              <div className="text-xs text-gray-600">Add more quantifiable achievements to your experience section</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
