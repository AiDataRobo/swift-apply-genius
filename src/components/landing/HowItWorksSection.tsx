...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-background/50 via-accent/5 to-background/50 pointer-events-none" />
      
      <div className="container section-container">
        <div className="text-center mb-16">
          <h2 className="section-heading">How It <span className="neon-text">Works</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((step, index) => (
            ...
            >
              <div className="absolute -top-10 -left-10 text-9xl font-bold text-accent/10 select-none">
                {step.number}
              </div>
              <div className="futuristic-card p-8 rounded-2xl relative z-10 h-full">
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-accent/10 mb-6 neon-border">
            <span className="text-xs font-medium text-accent">Simple & Intuitive Process</span>
          </div>
          <h3 className="text-2xl md:text-3xl font-bold mb-6">
            From Blank Page to Job-Ready Documents in <span className="neon-text">Under 5 Minutes</span>
          </h3>
