...
const ModernTemplate = ({ resume, style, visibleSections }: ModernTemplateProps) => {
  const { 
    primaryColor = "#1a73e8", 
    fontFamily = "Inter",
    fontSize = "medium",
  ...
  return (
    <div className={spacingClass} style={{ fontFamily }}>
      ...
      {/* Skills Section */}
      {visibleSections.includes("skills") && resume.skills.length > 0 && (
        <div className="mb-6">
      ...
      {/* Experience Section */}
      {visibleSections.includes("experience") && resume.experience.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Experience
          </h2>
      ...
      {/* Education Section */}
      {visibleSections.includes("education") && resume.education.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Education
          </h2>
      ...
      {/* Projects Section */}
      {visibleSections.includes("projects") && resume.projects.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Projects
          </h2>
      ...
      {visibleSections.includes("certificates") && resume.certificates.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Certifications
          </h2>
      ...
      {/* Languages Section */}
      {visibleSections.includes("languages") && resume.languages && resume.languages.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Languages
          </h2>
      ...
      {/* Interests Section */}
      {visibleSections.includes("interests") && resume.interests && resume.interests.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold mb-2 pb-1 border-b" style={{ color: primaryColor }}>
            Interests
          </h2>
