            ...
            <div className="glass-card p-6 rounded-xl">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@swiftapply.com" className="text-sm text-primary hover:underline">
                    info@swiftapply.com
                  </a>
                  <p className="text-sm text-muted-foreground mt-2">
                    For technical support:
                  </p>
                  <a href="mailto:support@swiftapply.com" className="text-sm text-primary hover:underline">
                    support@swiftapply.com
                  </a>
                </div>
              </div>
            </div>
