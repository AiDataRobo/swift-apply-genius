  ...
  return (
    ...
    >
      <div className="prose prose-slate max-w-none">
        ...
        <p>
          By accessing or using EnhanceResume's services, you agree to be bound by these Terms of Service. 
          If you do not agree to these terms, please do not use our services.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          EnhanceResume provides an AI-powered resume and cover letter generator designed to help users create, 
        ...
        <p>
          ...
          EnhanceResume a worldwide, non-exclusive license to use, store, and process this content for the purpose 
          of providing our services to you.
        </p>

        <h2>5. Prohibited Uses</h2>
        <p>
          You agree not to use EnhanceResume for any unlawful purpose or in any way that might harm, damage, or 
          negatively affect the performance or functionality of our service.
        </p>

        <h2>6. Payment and Subscription</h2>
        <p>
          Certain features of EnhanceResume require a paid subscription. Billing terms and conditions will be 
        ...
        <p>
          The EnhanceResume service, including all content, features, and functionality, is owned by us and is 
          protected by international copyright, trademark, and other intellectual property laws.
        </p>

        <h2>9. Disclaimer of Warranties</h2>
        <p>
          EnhanceResume is provided "as is" without warranties of any kind, either express or implied. We do not 
          guarantee that our service will be uninterrupted, secure, or error-free.
        </p>

        <h2>10. Limitation of Liability</h2>
        <p>
          EnhanceResume shall not be liable for any indirect, incidental, special, consequential, or punitive damages 
          resulting from your use of or inability to use our service.
        </p>

        <h2>11. Changes to Terms</h2>
        <p>
          We reserve the right to modify these terms at any time. Continued use of EnhanceResume after such changes 
        ...
        <p>
          ...
          in which EnhanceResume operates, without regard to its conflict of law provisions.
        </p>

        <h2>13. Contact Information</h2>
        <p>
          If you have any questions about these Terms of Service, please contact us at support@enhanceresume.com.
        </p>
